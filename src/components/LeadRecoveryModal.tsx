          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div className="bg-neutral-50 border border-neutral-200 rounded-2xl p-3.5 space-y-1.5 text-xs">
              <div className="flex items-center justify-between font-bold text-neutral-900">
                <span>{lead.name}</span>
                <span className="px-2 py-0.5 text-[10px] font-extrabold bg-orange-100 text-orange-700 rounded-full">
              ...
              <div className="pt-1.5 border-t border-neutral-200 flex justify-between font-medium text-neutral-700">
                ...
                <span className="font-extrabold text-orange-600">৳{lead.cartValue}</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-neutral-100 border border-neutral-200 rounded-xl text-xs font-bold text-neutral-900 focus:outline-none focus:border-orange-500"
                />
              </div>
              <div>
                <label className="block text-xs font-bold text-neutral-700 mb-1">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full p-3 bg-neutral-50 border border-neutral-200 rounded-xl text-xs font-medium text-neutral-800 focus:outline-none focus:border-orange-500"
              />
            </div>
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <button
                type="submit"
                className="flex-1 py-2.5 bg-orange-500 hover:bg-orange-600 text-white font-bold text-xs rounded-xl shadow-md shadow-orange-500/20 flex items-center justify-center gap-2 transition-colors"
              >
