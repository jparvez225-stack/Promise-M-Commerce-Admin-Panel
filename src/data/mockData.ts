...
export const INITIAL_PRODUCTS: Product[] = [
  {
    ...
    vendor: 'Aura Global Ltd',
    outlets: ['Main Outlet (Dhaka)', 'Banani Hub', 'Chittagong Depot'],
    deliveryInfo: 'Inside Dhaka ৳60 | Outside ৳120',
    deliveryInsideDhaka: 60,
    deliveryOutsideDhaka: 120,
    codAvailable: true,
    warranty: '12 Months Official Warranty',
    returnPolicy: '7 Days Replacement',
    otherInfo: '★ 4.9 (1,240 Sold) • Top Seller',
    stockQty: 85
  },
  {
    id: 'prod-2',
    ...
    vendor: 'Sony BD Official Importer',
    outlets: ['Main Outlet (Dhaka)', 'Uttara Outlet'],
    deliveryInfo: 'Free Delivery Nationwide',
    deliveryInsideDhaka: 0,
    deliveryOutsideDhaka: 0,
    codAvailable: true,
    warranty: '24 Months Sony Warranty',
    returnPolicy: '7 Days Return',
    otherInfo: '★ 4.8 (420 Sold) • Premium Audio',
    stockQty: 32
  },
  {
    id: 'prod-3',
    ...
    rating: 4.6,
    sku: 'HVT-H69-WHT',
    barcode: '693954250123',
    status: 'Active',
    category: 'Gaming Headsets',
    brand: 'HAVIT',
    createdAt: '2026-07-18 | 05:40 PM',
    createdBy: 'Sales Manager',
    vendor: 'HAVIT BD Distributor',
    outlets: ['Main Outlet (Dhaka)', 'Sylhet Depot', 'Rajshahi Outlet'],
    deliveryInfo: 'Inside Dhaka ৳60 | Outside ৳120',
    deliveryInsideDhaka: 60,
    deliveryOutsideDhaka: 120,
    codAvailable: true,
    ...
    otherInfo: '★ 4.6 (890 Sold) • Best Value',
    stockQty: 120
  },
  {
    id: 'prod-4',
    title: 'EKSA E900 Pro 7.1 Surround Headset',
    price: 2500,
    originalPrice: 3500,
    ...
    rating: 4.7,
    sku: 'EKS-E900-RED',
    barcode: '840129384012',
    status: 'Active',
    category: 'Gaming Headsets',
    brand: 'EKSA',
    createdAt: '2026-07-15 | 11:10 AM',
    createdBy: 'Inventory Admin',
    vendor: 'EKSA Gaming Tech',
    outlets: ['Main Outlet (Dhaka)', 'Chittagong Depot'],
    deliveryInfo: 'Inside Dhaka ৳60 | Outside ৳120',
    deliveryInsideDhaka: 60,
    deliveryOutsideDhaka: 120,
    codAvailable: true,
    ...
    returnPolicy: '7 Days Return',
    otherInfo: '★ 4.7 (650 Sold) • Pro Gamer Choice',
    stockQty: 48
  },
  {
    id: 'prod-5',
    title: 'Anker Soundcore Liberty 4 NC TWS',
    price: 8990,
    originalPrice: 11500,
    description: 'Adaptive ANC 2.0, Hi-Res Wireless Audio, 50-Hour Playtime, LDAC Tech Earbuds',
    image: 'https://images.unsplash.com/photo-1572536147248-ac59a8abfa4b?auto=format&fit=crop&w=800&q=80',
    colors: [{ name: 'Navy Blue', hex: '#1e3a8a' }, { name: 'Velvet Black', hex: '#000000' }],
    inStock: true,
    salesCount: 310,
    rating: 4.9,
    sku: 'ANK-L4NC-BLU',
    barcode: '848061029314',
    status: 'Active',
    category: 'TWS Earbuds',
    brand: 'Anker Soundcore',
    createdAt: '2026-07-12 | 03:00 PM',
    createdBy: 'Admin User',
    vendor: 'Anker BD Official',
    outlets: ['Main Outlet (Dhaka)', 'Banani Hub', 'Uttara Outlet'],
    deliveryInfo: 'Inside Dhaka ৳60 | Outside ৳120',
    deliveryInsideDhaka: 60,
    deliveryOutsideDhaka: 120,
    codAvailable: true,
    ...
    returnPolicy: '7 Days Replacement',
    otherInfo: '★ 4.9 (310 Sold) • LDAC Hi-Res Audio',
    stockQty: 29
  }
];
...
export const INITIAL_STOREFRONT_CONFIG: StorefrontConfig = {
  announcementText: 'Order 4 items and get 25% Special Instant Discount!',
  announcementEnabled: true,
  heroBadge: '25% SPECIAL DISCOUNT — LIMITED TIME OFFER',
  productTitle: 'Aura Pro Studio Wireless ANC Headphones',
  productSubTitle: 'Model: AP-ANC-2026 • High Fidelity Audio',
  productDescription: 'Aura Pro Studio Headphones with -42dB Active Noise Cancellation, 40-hour battery life, and premium studio sound drivers.',
  basePrice: 4990,
  originalPrice: 6650,
  ...
  features: [
    ...
    '1 Year Official Warranty & 7 Days Free Replacement'
  ],
  colors: [
